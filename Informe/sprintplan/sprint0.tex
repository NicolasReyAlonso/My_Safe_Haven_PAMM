...
{8h}
{Desarrollador}
{Tener un backend funcional}
{poder desarrollar}
{
\item Los errores lanzados deben ser claros.
...
{4h}
{Usuario}
{poder visualizar mis datos personales}
{saber que son correctos}
{
\item Debe verse la imagen de perfil.
\item Debe verse el tipo de cuenta que es.
\item Debe de verse la id de usuario
}
...
{poder ver su feed}
{
\item Solo puedo poder suscribirme si estoy en el rango de uso del haven
}
